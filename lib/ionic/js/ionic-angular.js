 ...
 *           'persons-tab': {
 *             prefetchTemplate: false,
 *             templateUrl: "tabs-templates/persons.html",
 ...
 *
 * ```html
 * <a menu-close href="#/persons" class="item">Home</a>
 * ```
 */
IonicModule
 ...
 *
 * ```html
 * <a nav-direction="forward" href="#/persons">Home</a>
 * ```
 */
IonicModule
 ...
 *
 * ```html
 * <a nav-transition="none" href="#/persons">Home</a>
 * ```
 */
IonicModule
 ...
 * and then try to load persons.html into the `<ion-nav-view>`.
 *
 * Pages are loaded by the URLs given. One simple way to create templates in Angular is to put
 * them directly into your HTML file and use the `<script type="text/ng-template">` syntax.
 * So here is one way to put persons.html into our app:
 *
 * ```html
 * <script id="persons" type="text/ng-template">
